...
export class ModernOfficeList extends React.Component<IModernOfficeListProps, any> {
    ...
    constructor(props: IModernOfficeListProps) {
        ...
        this.config = new ModernOfficeListState(this.props.items, this.props.hasNextPage, this.props.views, this.props.itemIdProperty, this.props.hideDelete, this.props.itemTitleProperty,
            ...
            this.props.onSortChanged, this.props.onFilterChanged, this.props.onActionClicked, this.props.getNewActionFieldGroups, this.props.getNewActionItem, this.props.onSaveNewAction,
    ...
    render() {
        ...
        const content = this.config.showProgress ? <ModernProgressBar percentComplete={this.config.currentProgress} description={this.config.processProgress.description}
