...
var ModernViewItemPanel = /** @class */ (function (_super) {
    ...
    ModernViewItemPanel.prototype.render = function () {
        ...
        return (React.createElement("span", null,
            ...
            React.createElement(ModernCustomActionPanel_1.ModernCustomActionPanel, { isVisible: this.config.customActionPanelVisible, item: this.config.item, titleProperty: this.props.titleProperty, action: this.config.currentAction, descriptionProperty: this.props.descriptionProperty, secondaryDescriptionProperty: this.props.secondaryDescriptionProperty, renderCustomAction: this.config.onRenderCustomAction, colorProperty: this.props.colorProperty, imageProperty: this.props.imageProperty, onDismiss: this.config.onCustomActionDismiss }),
