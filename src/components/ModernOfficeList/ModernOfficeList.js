...
var ModernOfficeList = /** @class */ (function (_super) {
    ...
    function ModernOfficeList(props) {
        ...
        _this.config = new ModernOfficeListState_1.default(_this.props.items, _this.props.hasNextPage, _this.props.views, _this.props.itemIdProperty, _this.props.hideDelete, _this.props.onNextPage, _this.props.onSearch, _this.props.onViewChange, _this.props.onNewItem, _this.props.onSaveNewItem, _this.props.onDeleteItem, _this.props.onUpdateItem, _this.props.onViewOffsetChange, _this.props.onSortChanged, _this.props.onFilterChanged, _this.props.onActionClicked, _this.props.getNewActionFieldGroups, _this.props.getNewActionItem, _this.props.defaultView, _this.props.language);
