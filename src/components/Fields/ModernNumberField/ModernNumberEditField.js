...
var ModernNumberEditField = /** @class */ (function (_super) {
    __extends(ModernNumberEditField, _super);
    function ModernNumberEditField(props) {
    ...
    ModernNumberEditField.prototype.textToNumber = function (value) {
    ...
    ModernNumberEditField.prototype.render = function () {
